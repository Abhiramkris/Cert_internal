  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-20 font-sans mt-8">
      <div className="flex flex-col gap-2 mb-8 px-2">
        <h2 className="text-[11px] font-semibold tracking-[0.3em] uppercase text-zinc-600">System Architecture</h2>
        <h1 className="text-4xl font-semibold text-zinc-900 tracking-tight">Admin Control Panel</h1>
        <p className="text-zinc-700 font-medium max-w-2xl mt-2">
