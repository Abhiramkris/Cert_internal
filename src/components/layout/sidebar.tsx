...
export function Sidebar({ user }: SidebarProps) {
  ...
  return (
    <div className="w-[84px] hover:w-72 transition-all duration-300 ease-in-out h-full border-r border-zinc-100 bg-[#F9FAFB] flex flex-col font-sans group relative z-50 overflow-hidden shrink-0">
      <div className="p-6 flex-1 overflow-y-auto">
        ...
        <div className="space-y-10">
          ...
          <div>
            <h3 className="px-4 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-400 mb-5 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">Workflow</h3>
            <nav className="space-y-1.5">
          ...
          {user?.role === 'Admin' && (
            <div>
              <h3 className="px-4 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-400 mb-5 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">General</h3>
              <nav className="space-y-1.5">
