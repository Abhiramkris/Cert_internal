  ...
  if (assigned.length === 0) {
    return (
      <div className="space-y-4 mb-10 animate-in fade-in slide-in-from-top-4 duration-700">
        <h2 className="text-[11px] font-semibold uppercase tracking-[0.2em] text-zinc-600 flex items-center gap-2 ml-1">
        ...
        <Card className="rounded-[2rem] border-none bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 border border-zinc-50 text-center">
          ...
          <p className="text-sm font-semibold text-zinc-600 max-w-sm mx-auto leading-relaxed">
  ...
  return (
    <div className="space-y-4 mb-10 animate-in fade-in slide-in-from-top-4 duration-700">
      <div className="flex items-center justify-between">
        ...
        <Badge variant="outline" className="rounded-full border-zinc-200 text-zinc-700 font-semibold px-3 py-0.5 bg-zinc-50">
            ...
            <Card className="rounded-[2rem] border-none bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.08)] transition-all cursor-pointer group h-full overflow-hidden border border-zinc-50 relative">
              ...
              <CardContent className="p-6 pl-8">
                <div className="flex justify-between items-start mb-4">
                  <span className="text-[10px] font-semibold uppercase tracking-widest text-blue-600 bg-blue-50 px-2.5 py-1 rounded-full">
                    {p.status?.split('_')?.pop() || 'ACTIVE'}
                  </span>
                  <div className="w-8 h-8 rounded-full bg-zinc-50 flex items-center justify-center text-zinc-600 group-hover:bg-zinc-900 group-hover:text-white transition-all">
                    <ArrowUpRight className="w-4 h-4" />
                  </div>
                </div>

                <h3 className="text-lg font-semibold text-zinc-900 leading-tight mb-2 group-hover:text-zinc-600 transition-colors">
                  {p.client_name}
                </h3>
                ...
                <div className="flex flex-col gap-2 mt-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9px] font-semibold text-zinc-500 uppercase tracking-tighter">In Progress</span>
                  </div>
                </div>
              </CardContent>
            </Card>
