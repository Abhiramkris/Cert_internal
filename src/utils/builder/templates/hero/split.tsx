...
export const HERO_SPLIT = {
  ...
  preview: (config: any, content: any, settings: any) => {
    ...
    return (
      <section className="py-20 px-8 bg-zinc-950 text-white border-b border-zinc-900">
        <div className="grid grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            <h1 
              className="text-4xl font-black tracking-tighter italic leading-none"
          ...
          <div className="aspect-[4/5] bg-zinc-900 rounded-3xl border border-zinc-800 skew-y-2 flex items-center justify-center">
...
export default function Hero() {
  ...
  const variants = {
    ...
    fade: { initial: { x: -20, opacity: 0 }, whileInView: { x: 0, opacity: 1 } },
    ...
    <section className="py-24 px-8 bg-zinc-950 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <motion.div 
          ...
          className={\`flex flex-col \${alignmentClass} space-y-10\`}
        >
          <h1 
            className="text-7xl font-black tracking-tighter leading-none italic"
          ...
          <p className={\`text-lg text-zinc-400 font-medium leading-relaxed max-w-lg \${mx}\`}>
